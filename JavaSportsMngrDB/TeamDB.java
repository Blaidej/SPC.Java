   ...
   public static void addTeams(Connection conn)
   {
      ...
      try
      {
         ...
         do
         {
			...
			System.out.print("Enter a new Team's name:");
      ...
      try
      {
         ...
         do
         {
            ...
            if(result.next())
            {
                ...
                // game number
			    sqlStatement = "UPDATE games SET HomeTeamScore = " +
						score1 + " WHERE HomeTeam = '" + homeTeam + "'"; 
							
				stmt.executeUpdate(sqlStatement);
				
				sqlStatement = "UPDATE games SET VisitorTeamScore = " +
						score2 + " WHERE VisitorTeam = '" + visitingTeam + "'"; 
               ...
               if(score1 < score2)
               {
				    ...
				    sqlStatement = "SELECT Losses FROM Teams WHERE TeamName = '" +
						homeTeam + "'";
					...
					if(result.next())
					{
						...
						currentH = result.getInt("Losses");
						
						currentH++;
						
						sqlStatement = "UPDATE Teams SET Losses = " +
						 + currentH  + " WHERE TeamName = '" + homeTeam + "'"; 
						

						stmt.executeUpdate(sqlStatement);
					}
					
					sqlStatement = "SELECT Wins FROM Teams WHERE TeamName = '" +
					visitingTeam + "'";
					...
					if(result.next())
					{
						...
						currentV = result.getInt("Wins");
						
						currentV++;
						
						sqlStatement = "UPDATE Teams SET Wins = " +
							+ currentV  + " WHERE TeamName = '" +
							visitingTeam + "'"; 	
               ...
               else
               {
                  ...
                  // that team's record.
                  // Do the same for the visiting team
				 sqlStatement = "SELECT Ties FROM Teams WHERE TeamName = '" +
						homeTeam + "'";
