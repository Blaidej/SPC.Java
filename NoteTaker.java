...
public class NoteTaker extends JFrame
{
   ...
   */
   ...
   {
		//takes and adds actionlisteners to the view menu and adds 
		//look and feel, and the scrollBar chooser menu.
   ...
   */
   ...
   public void createLookAndFeel()
   {
	    ...
	    JMenuItem item;
		//adds listeners to the selections in the look and feel menu
   ...
   */
   ...
   public void createScrollBars()
   {
	    ...
	    JMenuItem item;
	   //adds listeners to the selections in the scroll bar menu
   ...
   /**
      ...
      action events.
	  @throws exception if the look and feel doesn't apply
   */
   ...
   private class MenuListener implements ActionListener
   {
      ...
      public void actionPerformed(ActionEvent e)
      {
		...
		/*will set the look and feel to the specific look when choosen
		try catch blocks are needed when updating look and feel since it
		...
		*/
		...
		//else if branches for setting the scollbar policies/visibilty
